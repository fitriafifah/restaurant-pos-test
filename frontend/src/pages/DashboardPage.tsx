...
export default function DashboardPage() {
  ...
  const openOrder = useMutation({
    mutationFn: (tableId: number) => api.post('/orders', { table_id: tableId }),
    onSuccess: (res) => {
  ...
  if (error) return <Alert severity="error">Gagal memuat data meja</Alert>;
